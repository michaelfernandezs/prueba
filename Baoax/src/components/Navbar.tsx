...
const Navbar=()=>{
    ...
    <div  className="lg:hidden block absolute top-16 w-full left-0 right-0 bg-slate-900 transition">
        <ul className="text-center text-xl p-20  text-white-500">
    ...
    return(
       <nav>
        <div className="h-10vh flex  justify-between z-50 text-white lg:py-5 px-20 py-4 border-b border-slate-800" >
            ...
            <span className="text - text-3xl font-bold text-white-500">Michael</span>
            </div>
        ...
        <div className="lg:flex md:flex lg: flex-1 items center justify-end font-normal hidden" >
            ...
            <Link spy={true} smooth={true} to="Projects">
            <li className="hover:text-fuchsia-600 transition border-b-2 border-slate-500 hover:border-fuchsia-600 cursor-pointer"> Projects </li>
            </Link>
            <Link spy={true} smooth={true} to="Contact">
