...
const Contact=()=>{
    return(
       ...
       <div id="Contact" className="p-4 lg:p-20 flex flex-col items-center justify-center" >
        ...
        <form action="" className="flex flex-col gap-6 lg:w-1/2">
            <div className=" lg:flex  gap-9 ">
                <input className="w-full lg:my-3 my-4  rounded-lg bg-slate-800 p-4 border-2 border-fuchsia-800 b_glow text-xl text-slate-500" placeholder="Enter your Name" type=""/>
            ...
            <textarea className="w-full my-3 rounded-lg bg-slate-800 p-4 border-2 border-fuchsia-800 b_glow text-xl text-slate-500" placeholder="Write your Message.." name="" id="" cols={30} rows={10} ></textarea>
